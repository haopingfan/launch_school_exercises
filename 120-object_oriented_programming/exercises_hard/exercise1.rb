...
# clients of the class attempt to access the secret data. Here is the class in its current 
# form:
...
# That is, any call to the class which will result in data being returned must first call a 
# logging class. The logging class has been supplied to Alyssa and looks like the following:
...
# SecurityLogger be passed in as an additional argument. It may be helpful to review the lecture
